...
def record_data(session_time=8.0, target=None):
    with open('./logs/' + timestamp + '_' + user_name + '_' + class_type + '.csv', 'a') as f:
...
print '\nFile has been saved to:' + '/logs/' + timestamp + '_' + user_name + '_' + class_type + '.csv'
